...
- **Já tem sua lista em outro app?** Agora dá pra **colar** (botão "📋 Colar lista" na Coleção) e o app
  ...
  Você escolhe se é "**Tenho**" (vai pra coleção) ou "**Preciso**" (vai pra lista do que você precisa),
  confere quantas foram reconhecidas (e quantas você já tinha / não deu pra ler) e confirma. Reaproveita o
  mesmo leitor de listas que já existia.
